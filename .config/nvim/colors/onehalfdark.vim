...
let s:red         = { "gui": "#ff5f87", "cterm": "204" }
let s:green       = { "gui": "#87d787", "cterm": "114" }
let s:yellow      = { "gui": "#ffff87", "cterm": "228" }
let s:blue        = { "gui": "#5fafff", "cterm": "75"  }
let s:purple      = { "gui": "#af87d7", "cterm": "140" }
let s:cyan        = { "gui": "#5fafaf", "cterm": "73"  }
let s:white       = { "gui": "#ffffff", "cterm": "15"  }
let s:gray        = { "gui": "#bcbcbc", "cterm": "250" }
...
let s:gutter_fg   = s:gray
let s:non_text    = { "gui": "#4e4e4e", "cterm": "239" }

let s:cursor_line = s:non_text
let s:color_col   = s:non_text
...
call s:h("StatusLineNC", s:gray, s:cursor_line, "")
